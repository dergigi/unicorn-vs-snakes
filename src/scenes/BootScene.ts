...
export class BootScene extends Phaser.Scene {
  ...
  preload(): void {
    ...
    this.load.image("mushroom-powerup", "assets/sprites/mushroom.png");
    ...
    this.load.svg("magnifying-glass", "assets/ui/magnifying-glass.svg", { width: 32, height: 32 });
    ...
    this.load.spritesheet("torch", "assets/sprites/torch-trimmed.png", {
      frameWidth: 85,
      frameHeight: 149,
      spacing: 1
    });
